...
public class CreateFlightPlan {
    ...
    public void the_user_add_a_flight_plan_description(String description) throws Exception {
        customer.adds_flight_plan_description(description);
    }

    @Then("^the user sees the flight plan card with the correct \"([^\"]*)\"$")
    public void the_user_sees_the_flight_plan_card_with_the_correct(String description) throws Exception {
        customer.checks_flight_plan_description(description);
    }
